...
import 'package:fluflu/src/pages/client/messages/client_messages_page.dart';  // Nueva ruta
import 'package:fluflu/src/pages/client/roomies/client_roomies_page.dart';    // Nueva ruta
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        // Rutas adicionales basadas en los roles mencionados
        ...
        '/create_alojamiento': (BuildContext context) => CreateAlojamientoPage(),
        ...
        // Ruta para invitados
        'client/guest/list': (BuildContext context) => ClientAlojamientoListPage(isGuest: true),  // Ruta para invitados
